...
namespace JBooth.MicroSplat
{
   ...
   public class MicroSplatBaseFeatures : FeatureDescriptor
   {
      ...
      public override string[] Pack()
      {
         ...
         else if ( blendMode == BlendMode.MaskBlended ) //--nox microsplat
         {
            features.Add ( GetFeatureName ( DefineFeature._MASKBLEND ) );
         }
      ...
      public override void Unpack(string[] keywords)
      {
         ...
         if ( HasFeature( keywords, DefineFeature._MASKBLEND ) ){ //--nox microsplat
            blendMode = BlendMode.MaskBlended;
         }
      ...
      public override void WriteProperties(string[] features, System.Text.StringBuilder sb)
      {
         ...
         if ( blendMode == BlendMode.MaskBlended ) //--nox microsplat
         {
            sb.AppendLine ("      _HybridHeightBlendDistance(\"Mask Blend Distance\", Float) = 300");
         }
