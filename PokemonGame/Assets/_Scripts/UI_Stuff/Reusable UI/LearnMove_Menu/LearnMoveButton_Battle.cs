...
public class LearnMoveButton_Battle : MonoBehaviour, ISelectHandler, IDeselectHandler, ICancelHandler, ISubmitHandler
{
    private LearnMove_Battle _learnMenu;
    ...
    public void Setup( ILearnMoveContext learnMenu, MoveSO move ){
        _learnMenu = (LearnMove_Battle)learnMenu;
        _assignedMove = move;
    }
